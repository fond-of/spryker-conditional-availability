 ...
 */
class QuantityGreaterZeroConditionalAvailabilityQueryExpanderPlugin extends AbstractPlugin implements QueryExpanderPluginInterface
{
    /**
     * {@inheritdoc}
     *
    ...
    public function expandQuery(QueryInterface $searchQuery, array $requestParameters = [])
    {
        $this->getBoolQuery($searchQuery->getSearchQuery())->addMust(
            $this->getFactory()->createQueryBuilder()->createRangeQuery(
                PageIndexMap::QTY,
                0,
                null,
                'gt'
